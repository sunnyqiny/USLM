...
Parameter.k=2;% the number of shapelets in equal length 
Parameter.R=2;% the number of scales of shapelets length 
...
Parameter.lambda_1=100; % regularization parameter
Parameter.lambda_2=10000;% regularization parameter
Parameter.lambda_3=10000; % regularization parameter
Parameter.lambda_4=10000; % regularization parameter
...
tic;
[W_star, Y_star, S_star,GY_star,S_0,Y_0,W_0,F_tp1,wh_time]=GUSLA(T,Parameter,S_0,Y_0,W_star);
