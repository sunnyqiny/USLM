function [W_star, Y_star, S_star, GY_star, S_0,Y_0,W_0,F_t,F_tp1,wh_time]=GUSLA(T,Parameter)
...
F_tp1=function_value(X_tp1,GY_tp1,L_G_tp1,SS_tp1,W_tp1,Parameter); % calculate the value of objective function;
gap=F_t-F_tp1; 
...
W_tp1=update_W(X_tp1,GY_tp1,Parameter); %update W_tp1;
 W_tp1=z_regularization(W_tp1); % regularize W_tp1;
GY_tp1=update_GY(W_tp1,X_tp1,GY_tp1,L_G_tp1,Parameter); %update Y_tp1;
S_tp1=update_S(GY_tp1,X_tp1,W_tp1,G_tp1,S_tp1,Xkj_tp1_skl,SSij_tp1_sil,SS_tp1,Parameter); % update S_tp1;
...
for j=1:nY
    y_index=find(GY_tp1(:,j)==y_max(j));
    Y_star(1,j)=y_index; % the ultimate Y_star;
end
